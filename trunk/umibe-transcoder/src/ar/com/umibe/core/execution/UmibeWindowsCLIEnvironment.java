 ...
 */
public class UmibeWindowsCLIEnvironment implements IExecutionEnvironment {

	private final String CONSOLE_ENV = "cmd /c start \"Umibe\" /LOW /B /WAIT ";
	private final Runtime runtime = Runtime.getRuntime();
	private final SimpleLogger log = new SimpleLogger(UmibeWindowsCLIEnvironment.class);
